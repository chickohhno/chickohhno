...
![AWS CodeBuild](https://img.shields.io/badge/CodeBuild-000000?style=for-the-badge&logo=amazonwebservices&logoColor=white)

**Infrastructure as Code**  
![Terraform](https://img.shields.io/badge/Terraform-000000?style=for-the-badge&logo=terraform&logoColor=white)
![CloudFormation](https://img.shields.io/badge/CloudFormation-000000?style=for-the-badge&logo=amazonwebservices&logoColor=white)
...
|---|---|---|
| Mikrotik Certified Network Associate | MikroTik · MTCNA | 2022 |
| AWS Certified Solutions Architect – Associate | AWS · SAA-C03 | 2024 |
| AWS Certified Developer – Associate | AWS · DVA-C02 | 2024 |
| AWS Certified SysOps Administrator – Associate | AWS · SOA-C02 | 2024 |
| GitHub Foundations | GitHub | 2024 |
| AWS Certified DevOps Engineer – Professional | AWS · DOP-C02 | 2025 |
| AWS Certified AI Practitioner | AWS · AIF-C01 | 2025 |
| Certified Kubernetes Administrator | CNCF · CKA | 2025 |
| AWS Certified Security – Specialty | AWS · SCS-C03 | 2026 |
...
Managed cloud infrastructure and Kubernetes workloads for a secure digital wallet platform. Handled EKS cluster operations, GitOps-based deployments, service mesh routing, and CI/CD pipeline automation.  
`AWS` `EKS` `ArgoCD` `Helm` `Istio` `GitHub Actions` `Aurora PostgreSQL` `Grafana` `Prometheus`

---

**💳 Payment Gateway Migration**  
Led infrastructure migration of a payment gateway from Azure to AWS. Handled cloud architecture setup, Kubernetes workload migration, zero-downtime cutover planning, CI/CD rebuild, and observability configuration.  
`Terraform` `AWS` `Azure` `EKS` `ArgoCD` `Helm` `GitHub Actions` `Aurora PostgreSQL` `Cloudflare`

---

**🛒 Local E-commerce Application**  
Provisioned and maintained cloud infrastructure and container orchestration for a local e-commerce platform. Managed EKS workloads, caching layer, GitOps deployment workflows, and monitoring stack.  
`AWS` `EKS` `MongoDB` `ElastiCache Redis` `ArgoCD` `Helm` `Nginx` `GitHub Actions` `Grafana` `Prometheus`
...
*`> the chicken is always in the cluster`*
